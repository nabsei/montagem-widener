...
**A one-knob stereo widener, companion plugin to [Phonk Finisher](https://github.com/nabsei/phonk-finisher).**
...
Same philosophy as Phonk Finisher: one macro parameter, no configuration.
...
- Custom dark-themed UI matching the Phonk Finisher brand identity: two
  L/R dots physically move apart as the knob turns, red (narrow) to green
  (wide)
