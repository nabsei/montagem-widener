...
// Same Montagem brand palette as the Finisher plugin: dark background,
// red = "narrow", green = "wide". The knob arc interpolates between them
...
class WidenerLookAndFeel : public juce::LookAndFeel_V4
{
public:
